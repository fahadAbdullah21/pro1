    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto ">
            ...
            <h1 class="display-4 fw-normal">اربح مع فهد</h1>
                ...
                <h3 id="countdown"></h3>
            <p class="lead fw-normal">السحب على نسخ مجانية من البرنامج</p>
        </div>
        <div class="container">
            <h3>للدخول في السحب اتبع الخطوات:</h3>
                <ul class="list-group list-group-flush">
                <li class="list-group-item">تابع البث المباشر على صفحتي </li>
                <li class="list-group-item">البث سيكون ساعة </li>
                <li class="list-group-item">خلال فترة البث سيتم فتح التسجيل وسنقوم بتسجيل اسمك و الايميل</li>
                <li class="list-group-item">بنهاية البث سيتم اختيار اسم واحد من قاعدة البيانات بشكل عشوائي</li>
                <li class="list-group-item">الفائز سيربح معنا نسخة من برنامجنا الخاص</li>
            </ul>
        </div>
    </div>
